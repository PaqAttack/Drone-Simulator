...
public class Graph {
	...
	// Displayed Plot radius in pixels
	...
	// Displayed Drone diameter in pixels
	...
	/**
	 * Gets Graph ID value from coordinates of grid position
	 * 
	...
	/**
	 * Sets all Graph IDs to 0. As written this code is unnecessary but was created
	...
	/**
	 * Get Graph 2D integer array.
	 * 
	 * @return Graph 2D integer array.
	 */
	...
	/**
	 * Returns the amount of protected tiles around a Plot. This is the number of
	 ...
	 * around the plot.
	 * 
	 * @return The amount of protected tiles around a Plot.
	 */
