...
public abstract class Drone {
	...
	/**
	 * Converts a Point to a Node for use in comparing or displaying desired data.
	 * Point Contains screen location data and resulting Node will contain graph
	 * references.
	 * 
	 * @param point Supplies the X, Y position to be used to make a new Node
	 * @return A Node with the graph X, Y corresponding to the screen X, Y of the
	 *         supplied Point.
	 */
	 ...
	 * 
	 * @param destination Node to be added as a waypoint.
	 */
	...
	/**
	 * Calculates Seconds that must pass to move from one Node to the next based on
	...
	/**
	 * Gets the calculated seconds of travel required per Node on the grid.
	 * 
	 * @return calculated seconds of travel required per Node on the grid.
	 */
	 ...
	 * 
	 * @return Node representing the waypoint the drone is currently traveling
	 *         toward.
	 */
