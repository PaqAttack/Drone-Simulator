...
public class DroneScannerA {
	...
	/**
	 * Creates a drone scanner object that scans for TargetPlotA Objects.
	 * 
	...
	/**
	 * Checks all plots and adds any TargetPlotA plots within range to the
	 ...
	 * provided Plot as a double.
	 * 
	 * @param p The Plot from which the distance to is being calculated.
